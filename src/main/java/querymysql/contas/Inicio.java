    ...
    private void crearCCMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_crearCCMouseClicked
        ...
        if (this.ok) {
            try {
                ...
                if (created == "ok") {
                    JOptionPane.showMessageDialog(null, "Conta criada", "Parabens!", 0, null);
                    showLG();
                } else {
                    JOptionPane.showMessageDialog(null, "No se pudo crear la cuenta", "Erro!", 0);
                }
            } catch (Throwable e) {
